...
class EmployeeUpdateScreen extends StatefulWidget {
  ...
  EmployeeUpdateScreen({required this.employee});
...
class _EmployeeUpdateScreenState extends State<EmployeeUpdateScreen> {
  ...
  void initState() {
    ...
    _dateOfBirthController = TextEditingController(text: widget.employee.dateOfBirth.toIso8601String().split('T')[0]);
    _dateOfHireController = TextEditingController(text: widget.employee.dateOfHire.toIso8601String().split('T')[0]);
    _selectedGender = widget.employee.gender ?? 'female'; // Set initial gender value with a fallback
  }
